...
public class IndexBar extends View {
    ...
    public IndexBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.IndexBar, defStyleAttr, 0);//获取属性的数组
        normalColor = a.getColor(R.styleable.IndexBar_normalColor, Color.GRAY);//正常字体的颜色  默认灰色
        selecColor = a.getColor(R.styleable.IndexBar_selecColor, Color.BLUE);//选中的字体颜色      默认蓝色
        dimension = a.getDimensionPixelSize(R.styleable.IndexBar_indexSize, sp2px(14));//字体大小属性  默认14sp
        a.recycle();//回收
        init();
    }
